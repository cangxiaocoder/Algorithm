...
/**
  ...
  */
public class IntegerFormatENV2 {
    ...
    public String formatInteger(int num) {
        ...
        for (int i = 0; i < group.size(); i++) {
            ...
            if (!formatTen.isEmpty()){
                if (i > 0 && group.get(i - 1) < 100){
                    result = formatTen + THOUSANDS[i] + " and " + result;
                    continue;
                }
    ...
    private String formatTen(int num){
        ...
        //小于1000的 999
        if (num % 100 < 10){
            return LESS_THAN_20[num / 100] + HUNDRED + " and " + formatTen(num % 100);
        }
...
//        System.out.println(new IntegerFormatEN().formatInteger(1000000000));
        System.out.println(new IntegerFormatENV2().formatInteger(12345));
        System.out.println(new IntegerFormatENV2().formatInteger(1001));
        System.out.println(new IntegerFormatENV2().formatInteger(10001));
        System.out.println(new IntegerFormatENV2().formatInteger(1000000001));
        System.out.println(new IntegerFormatENV2().formatInteger(1234567));
    }
}
